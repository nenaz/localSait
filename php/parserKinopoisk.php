<?php
	...
	if(isset($_GET['filmName'])){
        ...
        $numberFilm = mt_rand(298,957405);
        Logs('numberFilm', $numberFilm);
        $alreadyUsedMass = [];
	...
	$result=post('http://www.kinopoisk.ru/level/1/film/'.$numberFilm.'/',null,'http://www.kinopoisk.ru/');
	// $result=post('http://www.kinopoisk.ru/film/957405/',null,'http://www.kinopoisk.ru/');
    Logs('result', $result);
    ...
    Logs('name',$new['name']);
    Logs('originalname',$new['originalname']);
    Logs('script',$new['script']);
    Logs('genre',$new['genre']);
    Logs('rus_premiere',$new['rus_premiere']);
    Logs('acts',$new['acts']);
    Logs('MPAA',$new['MPAA']);
    Logs('time',$new['time']);
    Logs('description',$new['description']);
    Logs('imdb',$new['imdb']);
    Logs('kinopoisk',$new['kinopoisk']);
    Logs('director',$new['director']);
    Logs('year',$new['year']);
    Logs('country',$new['country']);
    /*
